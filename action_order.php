...
if(mysqli_query($link, $query)===true){
	...
	echo("<p style='color:blue;'><br/><b>پس از بررسی سفارش و تأیید آن، با شما تماس گرفته خواهد شد.</b></p>");
	
	echo("<p style='color:blue;'><br/><b>محصول خریداری شده از طریق پست جمهوری اسلامی ایران طبق آدرس درج شده ارسال خواهد شد.</b></p>");
	
	echo("<p style='color:blue;'><br/><b>درهنگام تحویل گرفتن محصول، آن را بررسی و از صحت و سالم بودن آن اطمینان حاصل کنید سپس مبلغ کالا را طبق فاکتور ارائه شده به مامور پست تحویل دهید.</b></p>");
