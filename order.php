		...
		<tr><td style="width: 60%;">
			...
			<table style="width: 100%;" border="0" style="margin-left: auto; margin-right: auto;">
				...
				<tr>
					...
					<td><input type="text" style="text-align: left;" id="mobile" name="mobile" placeholder="for example:09229890933" /></td>
				</tr>
			...
			<td>
				...
				function check_input()
				{
					...
					if(r==true){
						var validation=true;
						var count=document.getElementById('pro_qty');
			...
			<table>
				<tr>
					<td style="border-style: hidden; vertical-align: top; width: 33%;">
						...
						<img src="images/products/<?php echo($row['pro_image']) ?>" width="100%" height="100%" />
						<br/>
